// #TODO Workspaces: replace with workspace MobileNavBar or reuse playground one via MobileDrawer pattern per spec.md:219-220
'use client';
...
export default function MobileNavBar({ onOpenConversations, onOpenConfig, onToggleLogs }: MobileNavBarProps) {
  return (
