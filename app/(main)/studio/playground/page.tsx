        ...
        <div className="flex items-center justify-between border-b border-zinc-800 px-4 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <HelpTip text="Toggles the left configuration sidebar with agent selection and conversation history." side="right" />
            </div>
          </div>
          {selectedAgent && (
            <div className="flex items-center gap-3">
    ...
    <div className="fixed bottom-0 left-0 right-0 z-30 md:hidden border-t border-zinc-800 bg-zinc-950">
      <div className="flex items-center justify-around py-2">
        <div className="flex flex-col items-center gap-1">
          ...
          <HelpTip text="Opens the conversation history drawer to switch between or create new chats." side="top" />
        </div>
        <div className="flex flex-col items-center gap-1">
          <button
            type="button"
          ...
          <HelpTip text="Opens the agent configuration panel to change provider, model, temperature, and other settings." side="top" />
        </div>
        <div className="flex flex-col items-center gap-1">
          <button
            type="button"
